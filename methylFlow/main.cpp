...
//
// writes in tsv files
//   components: start end componentID numPatterns totalCoverage totalFlow<float> (scaled coverage)
//   patterns: start end componentID patternID totalFlow<float> methylationPattern (offset<int>:[M|U])
//   regions: start end componentID regionID coverage expectedCoverage<float> methylationPattern (offset<int>:[M|U])
